...
urlpatterns = [
   ...
   path('student/', views.student, name='student'),
    ...
    path('manual_attendence/', views.manual_atten_all, name='manual_attendence'),   #manual_atten_all,manual_attendence
  ...
  path('school_data_update/<str:machine_no>', views.school_data_update, name='school_data_update'),            # esp32 
   ...
   path('school_save_update/', views.school_save_update, name='school_save_update'),
    ...
    path('student_idcard/<int:id>',views.student_idcard,name='student_idcard'),
        path('staff_idcard/<int:id>',views.staff_idcard,name='staff_idcard'),
    ...
    path('school_login/<str:username>/<str:password>', views.school_login, name='school_login'),
    path('manual_atten_all/', views.manual_atten_all, name='manual_atten_all'),
    path('manual_atten_all_staff/', views.manual_atten_all_staff, name='manual_atten_all_staff'),

     path('parent_msg/', views.parent_absent_msg, name='parent_absent_msg'),
     path('homework/', views.home_work, name='home_work'),
     path('homework_delete/<int:id>', views.homework_delete, name='homework_delete'),
     path('homework/s/<int:id>', views.s, name='s'),
     path('homework_check/<int:id>', views.homework_check, name='homework_check'),
